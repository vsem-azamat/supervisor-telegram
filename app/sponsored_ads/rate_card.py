...
def render_rate_card() -> str:
    ...
    lines = [
        ...
        "",
        "Размещаем рекламу в студенческих чатах по согласованию.",
        "",
        "Базовый ориентир: 1 участник чата = 1 Kč за размещение.",
        "Финальная цена считается с коэффициентом от 0 до 2× — его выбирает администратор "
        "в зависимости от формата, тематики и качества объявления.",
        "При размещении сразу в нескольких чатах возможна скидка.",
        "",
