...
- When unmanaged ads appear in communities, help operators convert acceptable
  advertisers into approved sponsored placement requests instead of letting
  chaotic spam define the commercial surface.
...
| Monetization stays moderated | Sponsored placements require explicit admin approval, payment confirmation, and category policy checks before the bot posts |
...
| Sponsored ad conversion | Turn unmanaged ad attempts into approved paid placement requests where the community allows it | Ad detection handoff, agent-guided quote discussion, category policy, manual payment confirmation, sponsored bot posting, optional paid pinning |
...
- Admin-approved sponsored placements for chats that explicitly enable ads.
...
- Payment gateway automation, advertiser wallets, CRM, or a general-purpose ad
  marketplace.
...
- Subscriber monetization unrelated to sponsored placement requests.
...
- **"Sponsored post"** means a single labeled placement approved for a specific
  chat and request. It does not imply open ad inventory, automatic purchase, or
  guaranteed results.
